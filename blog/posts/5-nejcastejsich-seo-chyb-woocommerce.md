...
description: Title, H1, duplicitní kategorie, těžké obrázky a indexace filtrů. Pět chyb, které na WooCommerce vidíme opakovaně — a jak je ověřit za pár minut.
date: 2026-08-27
slug: 5-nejcastejsich-seo-chyb-woocommerce
---
...
Když chcete seznam nálezů na jednom místě, [bezplatný report](/#signup-form) čte veřejné HTML a PageSpeed. Na WooCommerce umíme část on-page věcí a kompresi obrázků i [automaticky](/#faq). Na ostatních platformách zůstává PDF návod.
